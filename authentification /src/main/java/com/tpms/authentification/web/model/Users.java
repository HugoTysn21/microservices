package com.tpms.authentification.web.model;
...
public class Users {
    ...
    public Users(int id, String name, String surname, String email, String password, String birth_date, String number, int currentPointOfFidelity) {
        this.id = id;
        this.name = name;
