...
public class UserDaoImpl implements UserDao {
    ...
    static {
        usersList.add(new Users(0,"stringer","Bell","stringerbell@gmail.com","tonymontana","12/12/1999","+1 33 44 32 11 89", 11 ));
        usersList.add(new Users(1,"Avon","Barksdale","avonbarksdale@gmail.com","baltimorelove","12/12/1997","+1 33 44 32 11 89", 19 ));
    }
