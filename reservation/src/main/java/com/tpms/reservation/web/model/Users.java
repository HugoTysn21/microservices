...
public class Users {
    ...
    public void fidelity(){
        this.pointOfFidelity = 50;
        // si l'user a pointOfFidelity >= pointofFidelity && l'user
        // a pointOfFidelity > pointofFidelity(inférieur a 100)
        // alors on lui fait en 1ere class.

        // si l'user a pointOfFidelity === pointofFidelity(égal à 100)
        // alors on lui fait en gratuit.
    }
